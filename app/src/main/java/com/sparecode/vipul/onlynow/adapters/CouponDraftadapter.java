...
public class CouponDraftadapter extends RecyclerView.Adapter<CouponDraftadapter.MyViewHolder> {
...
//    }
    ...
    private List<ClientDraftData> data;

    public CouponDraftadapter(Context context, List<ClientDraftData> data, OnClickListener listener) {
