 ...
 */
public class GalleryActivity extends CameraBaseActivity {
    ...
    private void init(){
        Util.initToolBar(this, toolbar, true);
        ...
        if(this.getIntent() != null){
            if(this.getIntent().hasExtra(Constants.KEY_PARAMS)) {
                ...
                if(object instanceof Params)
                    ...
                    Util.showLongSnack(parentLayout, "Provided serializable data is not an instance of Params object.");
                    setEmptyResult();
                }
            }
        }
    ...
    private void handleInputParams() {
        if(params.getPickerLimit() == 0){
            Util.showLongSnack(parentLayout, "Please mention the picker limit as a parameter.");
            setEmptyResult();
        }
        Util.setViewBackgroundColor(this, toolbar, params.getToolbarColor());
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        if (item.getItemId() == android.R.id.home) {
            ...
            if (Util.hasCameraHardware(this))
                ...
                Util.showLongSnack(parentLayout, "Sorry. Your device does not have a camera.");
            return true;
        }
    ...
    private class ApiSimulator extends AsyncTask<Void, Void, ArrayList<Image>> {
        ...
        protected void onPostExecute(ArrayList<Image> images) {
            ...
            if(error.length() == 0)
                ...
                Util.showLongSnack(parentLayout, error);
