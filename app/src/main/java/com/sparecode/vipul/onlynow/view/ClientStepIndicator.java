package com.sparecode.vipul.onlynow.view;
...
public class ClientStepIndicator extends View {

    private static final int DEFAULT_STEP_RADIUS = 10;   //DP
    private static final int DEFAULT_STOKE_WIDTH = 2;  //DP
    private static final int DEFAULT_STEP_COUNT = 2;  //DP
    ...
    public ClientStepIndicator(Context context) {
        super(context);
        init(context, null);
    }

    public ClientStepIndicator(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context, attrs);
    }

    public ClientStepIndicator(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        init(context, attrs);
    }

    @TargetApi(Build.VERSION_CODES.LOLLIPOP)
    public ClientStepIndicator(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
    ...
    private void init(Context context, AttributeSet attributeSet) {
        ...
        paint.setStrokeWidth(radius * 80 / 300);
    ...
    public static class ViewPagerOnChangeListener implements ViewPager.OnPageChangeListener {
        private final ClientStepIndicator stepIndicator;

        public ViewPagerOnChangeListener(ClientStepIndicator stepIndicator) {
