...
public class UserChangeLocationAdapter extends RecyclerView.Adapter<UserChangeLocationAdapter.MyViewHolder> {

    Context mContext;
    List<UserChangeLocationData> data;
    OnClickListener onClickListener;
    GetSelectedLocation getSelectedLocation;

    public UserChangeLocationAdapter(Context mContext, List<UserChangeLocationData> data, GetSelectedLocation getSelectedLocation) {
...
//        holder.text_payments.setText(history.getPayments());
        ...
        if (data.get(position).getIsActive() == 1)
        {
            holder.FrameactiveArea.setSelected(true);
        }
    }
...
//    }
    ...
    public interface GetSelectedLocation {
        void getSelectedLocation(UserChangeLocationData userChangeLocationData, boolean flag);
    }
